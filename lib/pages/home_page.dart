...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin{
  ...
  final List<Tab> _bottomTabs = <Tab>[
    new Tab(text: 'Today',icon: new Icon(Icons.today)),    //icon和text的显示顺序已经内定，如需自定义，到child属性里面加吧
    ...
    return new Scaffold(
            ...
            actions: <Widget>[
              new Column(
                ...
                children: <Widget>[
                  ...
                  new Row(
                    children: <Widget>[
                      new Text("${rmsBloc.currentState.startDate } - ${rmsBloc.currentState.endDate } ",textAlign: TextAlign.start,),
          ...
          body: new TabBarView(
              ...
              children:  [      //注意顺序与TabBar保持一直
                new News(data: branchStings,channel: channel),
                new News2(data: branchStings,channel: channel),
