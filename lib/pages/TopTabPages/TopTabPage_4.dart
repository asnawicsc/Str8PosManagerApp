...
class News4 extends StatefulWidget {
  News4({Key key, this.data, this.total1, this.total2, this.total3, this.channel, this.bloc})
...
class _MyTabbedPageState extends State<News4> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (date_start != null){
      ...
      date_start = widget.bloc.currentState.startDate;
      date_end = widget.bloc.currentState.endDate;
    }else{
    ...
    widget.bloc.dispatch(DateRange(start_date: widget.bloc.currentState.startDate, end_date: widget.bloc.currentState.endDate));
  }
...
class _NewsListState extends State<NewsList> {
  ...
  void initState() {
    ...
    widget.rmsBloc.dispatch(BranchName(
        ...
        start_date: widget.rmsBloc.currentState.startDate,
        end_date: widget.rmsBloc.currentState.endDate));
  }
...
//
//          print("datt: ${widget.rmsBloc.currentState.chartData}");
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    new MaterialButton(
                        ...
                        onPressed: () async {
                          if (widget.rmsBloc.currentState.startDate == null) {
                            setState(() {
                            ...
                            setState(() {
                              datetimestart =
                                  DateTime.parse(widget.rmsBloc.currentState.startDate);
                            });
                          }

                          if (widget.rmsBloc.currentState.endDate== null) {
                            setState(() {
                            ...
                            setState(() {
                              datetimeend =
                                  DateTime.parse(widget.rmsBloc.currentState.endDate);
                            });
                          }
                          ...
                          if (picked != null && picked.length == 2) {
                            setState(() {
                              ...
                              widget.rmsBloc.dispatch(DateRange(start_date: date_start, end_date: date_end));
