...
class News6 extends StatefulWidget {
  News6({Key key, this.data, this.total4, this.total5,this.total6, this.channel, this.bloc})
...
class _MyTabbedPageState extends State<News6> with TickerProviderStateMixin {
  Channel channel;
  List<String> data;
  List<dynamic> total4;
  List<dynamic> total5;
  ...
  void initState() {
    ...
    month_start = formatter.format(new DateTime.now().subtract(new Duration(days: 30)));
    month_end = formatter.format(new DateTime.now().subtract(new Duration(days: 30)));
          ...
          if (widget.total4
            ...
            for (var name in list) {
              dr.add(DataRow(cells: <DataCell>[
                DataCell(Text(name["month"].toString())),
