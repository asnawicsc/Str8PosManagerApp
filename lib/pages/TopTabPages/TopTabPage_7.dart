...
class News7 extends StatefulWidget {
  News7({Key key, this.data, this.total4, this.total5,this.total6, this.channel, this.bloc})
...
class _MyTabbedPageState extends State<News7> with TickerProviderStateMixin {
  Channel channel;
  List<String> data;
  List<dynamic> total4;
  List<dynamic> total5;
  ...
  void initState() {
    ...
    widget.bloc.dispatch(MonthRange(start_month: "01", end_month: month_end));
  }
      ...
      if (widget.total4.where((t) => t["branch"] == widget.branch).isNotEmpty) {
        if (widget.total4.where((t) => t["branch"] == widget.branch).first !=
          ...
          if (widget.total4
              ...
              0) {
            List list =
              widget.total4.where((t) => t["branch"] == widget.branch).toList()
            ;
